...
| Utilisateur connecté | Je veux pouvoir ajouter un astre | Contribuer au contenu du site | 8 |
| Utilisateur connecté | Je veux pouvoir éditer un astre | Modifier mes informations saisies | 8 |
| Utilisateur connecté | Je veux pouvoir supprimer un de mes astres (et non ceux des autres) | Retirer du contenu posté | 5 |
| Utilisateur connecté | Je veux pouvoir commenter un astre | Montrer ma participation au sein de la communauté | 5 |
| Utilisateur connecté | Je veux pouvoir supprimer un commentaire | Retirer du contenu posté | 5 |

#### Page Profil

| En tant que | Je veux | Afin de (si besoin/nécessaire) | Effort |
|--|--|--|--|
| Utilisateur connecté | Je veux pouvoir accéder à la liste de mes astres. | Retrouver les astres que j'ai crée dans la carte | 3 |
| Utilisateur connecté | Je veux pouvoir accéder à mon profil et pouvoir le modifier. | Mettre à jour mes informations | 5 |

#### Page et Rôle Admin

| En tant que | Je veux | Afin de (si besoin/nécessaire) | Effort |
|--|--|--|--|
| Administrateur | En tant qu'administrateur, je veux pouvoir accéder à toutes les fonctionnalités des autres rôles. | Pouvoir hériter des droits des membres lambdas | 3 |
| Administrateur | En tant qu'administrateur, je veux pouvoir accéder au back-office avec toutes les fonctionnalités | Modérer les contenus et les utilisateurs | 8 |
| Administrateur | En tant qu'administrateur, je veux pouvoir accéder à la liste de tous les utilisateurs et pouvoir intéragir avec| Modérer les utilisateurs | 2 |
| Administrateur | En tant qu'administrateur, je veux pouvoir bloquer définitivement un membre | Modérer les utilisateurs | 3 |
| Administrateur | En tant qu'administrateur, je veux pouvoir accéder à la liste de tous les astres et pouvoir intéragir avec| Modérer les astres | 2 |
| Administrateur | En tant qu'administrateur, je veux pouvoir accéder à la liste de tous les commentaires et pouvoir intéragir avec| Modérer les commentaires | 2 |
| Administrateur | En tant qu'administrateur, je veux pouvoir empêcher les mots interdits dans les formulaires (dictionnaire des mots interdits) | Modérer le contenu inapproprié | 5 |
